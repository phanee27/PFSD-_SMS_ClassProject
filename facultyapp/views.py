...
def submit_feedback(request):
    if request.method == 'POST':
        ...
        return redirect('facultyapp:feedback_success')  # Redirect to a success page or another view
    return render(request, 'facultyapp/feedback.html')

def feedback_success(request):
    return render(request, 'facultyapp/feedback_success.html')
...
def post_marks(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            from_email = 'venkataphaneendra8@gmail.com'
